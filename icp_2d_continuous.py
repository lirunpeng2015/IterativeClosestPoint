# This script performs iterative closets point for any number of point clouds
...
# returns cartesians coordinates as lists of x and y values from a lidar scan file
